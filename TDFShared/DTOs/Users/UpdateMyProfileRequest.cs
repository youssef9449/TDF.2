...
namespace TDFShared.DTOs.Users
{
    ...
    public class UpdateMyProfileRequest
    {
        ...
        public required string Department { get; set; } // Consider if this should be editable by user
        ...
        public required string Title { get; set; } // Consider if this should be editable by user
